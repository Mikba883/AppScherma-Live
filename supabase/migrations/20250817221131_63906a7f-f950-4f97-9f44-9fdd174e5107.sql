-- Ricreare il sistema di ranking completo

-- 1. Ricreare la funzione update_rankings_after_match senza team_id
...
-- 3. Popolare la tabella rankings con tutti gli atleti esistenti
INSERT INTO public.rankings (athlete_id)
SELECT user_id 
