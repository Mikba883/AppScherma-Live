-- Drop existing function and recreate with ranking position
DROP FUNCTION public.summary_by_athlete(date,date,text,integer,integer,text,uuid[],text,text);

-- Recreate function with ranking position included
