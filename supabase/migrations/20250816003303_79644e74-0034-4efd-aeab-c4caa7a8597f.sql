-- Add turno (bout_type) filter to summary_by_athlete function
...
AS $function$
  ...
  base as (
    ...
    where b.team_id = me.team_id
      ...
      and (_turno is null or b.bout_type = _turno)
  ),
  norm as (
    select
...
-- Add turno (bout_type) filter to list_bouts function
