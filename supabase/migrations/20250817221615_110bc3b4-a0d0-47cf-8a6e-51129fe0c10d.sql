-- Correggere la signature della funzione calculate_elo_change
DROP FUNCTION IF EXISTS public.calculate_elo_change(integer, integer, boolean, integer, numeric);
