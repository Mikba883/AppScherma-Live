-- Versione semplificata del sistema di ranking senza frequency stats

-- 1. Ricreare la funzione update_rankings_after_match senza frequency stats
...
BEGIN
  ...
  -- Calculate ELO changes (semplificato senza frequency multiplier)
...
-- 3. Ricalcolare tutti i ranking dai match esistenti
DO $$
DECLARE
  bout_record RECORD;
BEGIN
