-- Completare il sistema di ranking

-- 3. Ricreare il trigger function
...
-- 5. Reset e ricalcolo di tutti i ranking
DO $$
DECLARE
  bout_record RECORD;
BEGIN
  ...
  RAISE NOTICE 'Ranking system ricreato e tutti i match ricalcolati';
END $$;